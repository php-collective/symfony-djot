                            ...
                            ->arrayNode('extensions')
                                ...
                                ->arrayPrototype()
                                    ...
                                    ->children()
                                        ->scalarNode('type')
                                            ->isRequired()
                                            ->info('Extension type: autolink, code_group, default_attributes, external_links, frontmatter, heading_permalinks, mentions, semantic_span, smart_quotes, table_of_contents, wikilinks')
                                        ->end()
                                        // Autolink options
